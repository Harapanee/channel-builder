...
| 基準 | 判定者 |
|---|---|
| `channel-builder` がファクトリールート直下に新しいチャンネルフォルダを作成し、ヒアリングからStage 1相当のFactoryとして構築する | 機械+人間 |
...
(2026-07-09追記: channel-builderはサブフォルダ構築方式=Factory化へ更新済み。モード判定・ディレクトリ保護の確定仕様は本章の骨子ではなく channel-builder の SKILL.md を正とする)
